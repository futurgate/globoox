...
# RFC: Offline-First and Versioned Sync

> Current scoped invalidation is documented in [API and sync](../../reference/architecture/api-and-sync.md). Delta pull, tombstones, an outbox, and offline replay below are not current behavior.
