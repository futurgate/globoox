...
# RFC: Reader Typography Adaptive Layout

> Current Reader geometry remains fixed by the values in the [Reader architecture reference](../../reference/reader/architecture.md). The language profiles, runtime resolver modules, and automatic font fit below are proposals.
