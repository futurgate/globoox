      ...
      <div className={styles.container}>
        ...
        <div className={styles.book}>
          ...
          >
            ...
            <article id={`${id}-original`} className={`${styles.passage} ${styles.original}`} lang={original.lang} aria-hidden={!originalVisible} aria-label="Original Russian excerpt">
              <Excerpt passage={original} expanded={expanded} boundary="этого замечательного человека." compactBoundary="литературе." id={`${id}-original-excerpt`} />
            </article>

            <article id={`${id}-translated`} className={`${styles.passage} ${styles.translated}`} lang={translated.lang} aria-hidden={!translationVisible} aria-label="Translated English excerpt">
              <Excerpt passage={translated} expanded={expanded} boundary="this remarkable man." compactBoundary="in the literature." id={`${id}-translated-excerpt`} />
            </article>
            ...
            <div
              ...
              aria-label="Original and translated excerpt comparison"
              aria-describedby={`${id}-comparison-instructions`}
              aria-orientation="horizontal"
              aria-valuemin={0}
              aria-valuemax={100}
              aria-valuenow={Math.round(position)}
              aria-valuetext={`${Math.round(position)}% original Russian, ${Math.round(100 - position)}% English translation`}
          ...
          <p id={`${id}-comparison-instructions`} className={styles.srOnly}>Drag left or right to compare the original and translation. Use the arrow keys, Home or End when the comparison handle is focused.</p>
        </div>
