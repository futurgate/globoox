...
type: archive
status: archived
superseded_by: docs/reference/architecture/api-and-sync.md
---

# API Architecture: Globoox

> Historical snapshot. Use `docs/reference/architecture/api-and-sync.md` for current frontend behavior.
...
**Текущая документация кеша:** [Reader caching](../../../reference/reader/caching.md). Этот файл остаётся историческим API snapshot.
