...
Связанные документы:
- `../sync-refactor-attempt/content-caching-plan.md` — историческое описание IndexedDB кеша.
- `../../../reference/architecture/api-and-sync.md` — текущая документация прокси `/api/*` через Next.
