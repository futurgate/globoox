...
> **Related:** For the historical broader roadmap (paginator, gestures, tap zones), see [`reader-pagination-status-and-plan.md`](../sync-refactor-attempt/reader-pagination-status-and-plan.md).
