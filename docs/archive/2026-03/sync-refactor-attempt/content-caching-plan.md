...
type: archive
status: archived
superseded_by: docs/reference/reader/caching.md
---

# Content Caching (Client) — Implemented

> Historical snapshot. Current cache names and responsibilities are documented in `docs/reference/architecture/api-and-sync.md` and `docs/reference/reader/caching.md`.
...
См.:
- `../translation-v2/translation-v2-invariants-and-ui.md`
- `../translation-v2/translation-v2-reconcile-api.md`
- `../translation-v2/translation-v2-migration-and-test-checklist.md`
...
- Реализация:
  ...
  - ⚠️ **Legacy (до Translation v2):** автоперевод в Reader запускается только после серверного snapshot для текущих `(chapterId, lang)` (`hasServerSnapshot`).
    - В Translation v2 семантика “готовности” и reconcile меняются (см. `../translation-v2/translation-v2-invariants-and-ui.md`).
